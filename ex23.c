...
int main(int argc,char **args)
{
  ...
  PetscScalar    neg_one = -1.0,one = 1.0,value[3],a ;
  ...
  */
  for (i=rstart; i<rend; i++) {
  	  if (i==0){
  		  ...
  		  value[0] = 4; value[1] = 2; value[2] = -1-PETSC_i;
  		  ierr   = MatSetValues(A,1,&i,j,col,value,INSERT_VALUES);CHKERRQ(ierr);
  	  }
    }
